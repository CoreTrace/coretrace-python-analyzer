...
{
  "schema_version": 1,
  "tool": {"name": "coretrace-python-analyzer", "version": "0.11.0"},
...
```json
"tool": {
  "name": "coretrace-python-analyzer", "version": "0.11.0",
  "components": [
...
(`coretrace-python-analyzer 0.11.0; curated-advisories 2026.09.25 (sha256:…)`), so the
