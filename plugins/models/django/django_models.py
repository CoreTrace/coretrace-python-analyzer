...
class DjangoModels(ModelPlugin):
    ...
    models: ClassVar[tuple[Model, ...]] = (
        ...
        *(EntryPoint(_sym(decorator), "http") for decorator in _VIEW_DECORATORS),
        Sink(_sym("django.db.connection.cursor.execute"), TaintKind.SQL | TaintKind.CREDENTIAL),
        Sink(_sym("django.db.connection.cursor.executemany"), TaintKind.SQL | TaintKind.CREDENTIAL),
